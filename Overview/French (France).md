...
**Précis** - Bien que Reflex soit rapide et efficace, il ne gâchera pas l'expérience de jeu des joueurs légitimes, même les plus "habiles" ! Toutes les vérifications ont été testées intensivement pour fonctionner avec un nombre minimal de faux positifs, diminuant progressivement à chaque mise à jour.
...
Si vous souhaitez que votre thème ou votre traduction soit ajouté à la liste des thèmes par défaut (afin qu'il soit téléchargé par tous au démarrage), **n'hésitez pas à nous contacter !**
...
* [**Wiki de Reflex**](https://github.com/MeGysssTaa/ReflexIssueTracker)
...
<details>
  <summary>Spoiler: Conditions générales d'utilisation</summary>

## AVERTISSEMENT : CECI N'EST QU'UNE VERSION ABRÉGÉE DE L'[ACCORD ORIGINAL](https://g.reflex.rip/tos) CRÉÉ POUR FACILITER LA COMPRÉHENSION DES CONDITIONS D'UTILISATION DE REFLEX. EN UTILISANT REFLEX, VOUS ACCEPTEZ LES [CONDITIONS D'UTILISATION COMPLÈTES](https://g.reflex.rip/tos) — VEUILLEZ LES LIRE ENTIÈREMENT ET AVEC PRÉCISION : https://g.reflex.rip/tos

### VOUS POUVEZ :
  * Utiliser Reflex sur un nombre illimité de serveurs que vous possédez ou représentez.
  
### VOUS NE DEVEZ PAS :
  * Redistribuer Reflex ou ses parties à des tiers de quelque manière que ce soit.
  * Tenter de décompiler ou de désobscurcir le code source de Reflex ou de ses parties.
  * Demander ou tenter d'obtenir un remboursement total ou partiel, quel que soit le problème que vous rencontrez.
  
### VOUS DEVEZ :
  * Toujours maintenir à jour vos connaissances concernant les TOS de Reflex.
  * Assumer l'entière responsabilité de votre copie Reflex et de ce qui s'y passe.
  * Avoir 18 ans ou avoir l'autorisation de vos parents ou d'un autre représentant légal pour effectuer un achat.
  * Respecter les CGU de Reflex.
  
### NOUS :
  * Ne donnons aucune garantie ni responsabilité de quelque nature que ce soit concernant Reflex. Le logiciel est fourni "en l'état".
  * Nous nous réservons le droit de mettre à jour les TOS à tout moment, avec ou sans notification.
  * Nous nous réservons le droit d'appliquer diverses formes de sanctions à votre encontre en cas de violation des TOS.
  
</details>

<details>
  <summary>Spoiler: Politique de confidentialité</summary>
  
### See https://g.reflex.rip/privacy

**In a nutshell:** we may collect, store, process and delete, but not share, some of your personal data, including your server's geolocation, Reflex startup times, your Spigot account user ID, and some more. You can always request us an archieve containing everything we know about you, does not matter if you are an EU citizen or not.
